...
"")
        ...
        self.btnVoltar = QPushButton(self.frameCadAnimal)
        self.btnVoltar.setObjectName(u"btnVoltar")
        self.btnVoltar.setGeometry(QRect(440, 450, 131, 41))
        self.btnCadAnimal = QPushButton(self.frameCadAnimal)
        self.btnCadAnimal.setObjectName(u"btnCadAnimal")
        self.btnCadAnimal.setGeometry(QRect(580, 450, 131, 41))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnVoltar.setText(QCoreApplication.translate("MainWindow", u"Voltar a Pagina Inicial", None))
        self.btnCadAnimal.setText(QCoreApplication.translate("MainWindow", u"Cadastrar Novo Animal", None))
        self.label.setText("")
    # retranslateUi
